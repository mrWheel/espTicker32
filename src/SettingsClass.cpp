...
void SettingsClass::initializeSettingsContainers() 
{
  ...
  deviceContainer.addField({"devLDRpin", "GPIO Pin LDR (-1, 32, 33, 34, 35, 36, 39)", "n", 0, -1, 39, 1, &devLDRpin});
  deviceContainer.addField({"devLDRMinWaarde", "LDR Min. Waarde (%)", "n", 0, 5, 99, 1, &devLDRMinWaarde});
  deviceContainer.addField({"devLDRMaxWaarde", "LDR Max. Waarde (%)", "n", 0, 6, 100, 1, &devLDRMaxWaarde});
